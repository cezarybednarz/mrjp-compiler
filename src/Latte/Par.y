...
LValue : Ident { (fst $1, Latte.Abs.LVar (fst $1) (snd $1)) }
       | Expr6 '[' Expr ']' { (fst $1, Latte.Abs.LIdx (fst $1) (snd $1) (snd $3)) }

Expr7 :: { (Latte.Abs.BNFC'Position, Latte.Abs.Expr) }
Expr7 : Integer { (fst $1, Latte.Abs.ELitInt (fst $1) (snd $1)) }
...
Expr6 : LValue { (fst $1, Latte.Abs.ELValue (fst $1) (snd $1)) }
...
Expr5 : Expr6 '.' 'length' { (fst $1, Latte.Abs.ELength (fst $1) (snd $1)) }
